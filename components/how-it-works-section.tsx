      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-2">
            Como <span className="text-[#00FF90]">Funciona</span>
          </h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Um processo simples e transparente para garantir os melhores
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-[#00FF90]/30 to-transparent" />

          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative group">
                {/* Step Number */}
                <div className="absolute -top-3 -left-3 w-8 h-8 bg-[#00FF90] text-black rounded-full flex items-center justify-center font-bold text-sm z-10">
                  {index + 1}
                </div>
