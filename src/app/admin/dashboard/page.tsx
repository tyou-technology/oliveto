...
import { Scale, FolderOpen, ClipboardCheck, FileText, ChevronRight, CheckCircle2, Clock, Calendar, Plus, MessageSquare, TrendingUp, Eye, Download } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const activeProcesses = [
    { id: "PROC-001", title: "Revisão Fiscal 2023", status: "em_andamento", progress: 65, deadline: "15/12/2023" },
    { id: "PROC-002", title: "Auditoria Interna", status: "concluido", progress: 100, deadline: "10/11/2023" },
    { id: "PROC-003", title: "Consultoria Trabalhista", status: "em_andamento", progress: 30, deadline: "20/01/2024" },
  ];

  const upcomingTasks = [
    { date: "12 DEZ", title: "Reunião com Diretoria", time: "14:00 - 15:30" },
    { date: "15 DEZ", title: "Entrega de Relatório", time: "18:00" },
    { date: "18 DEZ", title: "Call de Alinhamento", time: "10:00 - 11:00" },
  ];

  const recentDocuments = [
    { name: "Balanço Patrimonial 2023.pdf", type: "PDF", date: "Hoje, 14:30", status: "novo" },
    { name: "Relatório de Auditoria.docx", type: "DOCX", date: "Ontem, 09:15", status: "visualizado" },
    { name: "Contrato de Prestação.pdf", type: "PDF", date: "05/12/2023", status: "visualizado" },
  ];
