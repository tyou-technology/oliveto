export const servicosPageContent = {
  pageTitle: "SERVIÇOS",
};

export const periciaServices = [
...
export const contabilidadeServices = [
...
export const auditoriaServices = [
...
export const serviceCategories = [
  { title: "PERÍCIA", services: periciaServices },
  { title: "CONTABILIDADE", services: contabilidadeServices },
  { title: "AUDITORIA", services: auditoriaServices },
];
